...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        '-------------(CHECKOUT SCREEN)----------------${widget.orderType}-----${widget.weight}');
                  ...
                  child: CustomScrollView(
                    ...
                    SliverToBoxAdapter(child: Consumer<OrderProvider>(
                      builder: (context, orderProvider, child) {
                        log('tracking tax------- ${orderProvider.trackModel}');
                                                                    ...
                                                                    children: [
                                                                      Expanded(
                                                                        ...
                                                                        key:
                                                                            dropDownKey,
                                                                        iconStyleData:
                                                                            IconStyleData(icon: Icon(Icons.keyboard_arrow_down_rounded, color: Theme.of(context).hintColor)),
                                                                        isExpanded:
                                                                            true,
                                                                        hint:
                                                                            Text(
                                                                        ...
                                                                        selectedItemBuilder:
                                                                            (BuildContext
                                                                                context) {
                                                                          return (splashProvider.deliveryInfoModelList?[orderProvider.branchIndex].deliveryChargeByArea ?? []).map<Widget>((DeliveryChargeByArea
                                                                              item) {
                                                                            return Row(children: [
                                                                              Text(
                                                                                item.areaName ?? "",
                                                                        ...
                                                                        items: (splashProvider.deliveryInfoModelList?[orderProvider.branchIndex].deliveryChargeByArea ??
                                                                            ...
                                                                            .toList(),
                                                                        value: orderProvider.selectedAreaID ==
                                                                                null
                                                                            ? null
                                                                        ...
                                                                        dropdownSearchData:
                                                                          ...
                                                                          searchMatchFn:
                                                                            ...
                                                                            DeliveryChargeByArea
                                                                                areaItem =
                                                                                (splashProvider.deliveryInfoModelList?[orderProvider.branchIndex].deliveryChargeByArea ?? []).firstWhere((element) => element.id.toString() == item.value);
                                                                            return areaItem.areaName?.toLowerCase().contains(searchValue.toLowerCase()) ??
                                                                                false;
                                                                          },
                                                                        ),
                                                                        buttonStyleData:
                                                                          ...
                                                                          decoration:
                                                                              BoxDecoration(
                                                                            border:
                                                                                Border.all(color: Theme.of(context).hintColor.withOpacity(0.5)),
                                                                            borderRadius:
                                                                              ...
                                                                              Text(
                                                                                index == 0
                                                                                    ...
                                                                                    : index == 1
                                                                                        ...
                                                                                        : date == null
                                                                                            ? getTranslated('choose_date', context)
                                                                                            : DateConverterHelper.estimatedDate(date!),
                                                                                style: poppinsRegular.copyWith(
                                                                    ...
                                                                    orderProvider.timeSlots ==
                                                                        ...
                                                                        : CustomSingleChildListWidget(
                                                                            scrollDirection:
                                                                                Axis.horizontal,
                                                                            itemCount:
                                                                                orderProvider.timeSlots?.length ?? 0,
                                                                            itemBuilder:
                                                                                (index) {
                                                                              return Padding(
