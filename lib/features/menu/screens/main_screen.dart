...
import 'package:flutter_grocery/common/widgets/custom_menu_pop_scope_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SplashProvider>(
      builder: (context, splash, child) {
        return CustomMenuPopScopeWidget(
          splash: splash,
                  ...
                  child: Scaffold(
                    ...
                    appBar: ResponsiveHelper.isDesktop(context) ? null : AppBar(
                      ...
                      leading: IconButton(
                          ...
                          icon: Icon(Icons.menu_outlined, size: 32,color: Theme.of(context).disabledColor,),
                          onPressed: () {
                            widget.drawerController.toggle();
                          }),
                      title: splash.pageIndex == 0 ? Row(children: [
                        Image.asset(Images.appLogo, width: 50),
                      ...
                      actions: splash.pageIndex == 0 ? [
                        ...
                        IconButton(
                          icon: Image.asset(Images.search, color: Theme.of(context).disabledColor, width: 25),
                          // icon: Icon(Icons.search,size: 30,color: Theme.of(context).disabledColor,),
                          onPressed: () {
                        ...
                        IconButton(
                            icon: Stack(clipBehavior: Clip.none, children: [
                              ...
                              Icon(Icons.shopping_cart, color: Theme.of(context).primaryColor, size: 35),
