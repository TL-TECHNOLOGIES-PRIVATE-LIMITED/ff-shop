...
class OrderRepo {
  ...
  List<String> getDateList(DateTime? date) {
    List<String> dates = [];
    ...
    date==null? dates.add(DateConverterHelper.slotDate(DateTime.now().add(const Duration(days: 2)))):dates.add(DateConverterHelper.slotDate(date));
    return dates;
  }
