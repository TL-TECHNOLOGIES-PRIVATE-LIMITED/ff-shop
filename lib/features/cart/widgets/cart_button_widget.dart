        ...
        Consumer<CouponProvider>(
            builder: (context, couponProvider, _) {
              return couponProvider.coupon?.couponType == 'free_delivery'
                  ? const SizedBox() :
              FreeDeliveryProgressBarWidget(subTotal: _total, configModel: _configModel);
            }
        ),
        ...
        CustomButtonWidget(
          ...
          onPressed: () {
            if(_itemPrice < _configModel.minimumOrderValue!) {
              ...
              print("--------------------(CART BUTTON WIDGET)--------------Discount: $_discount and Coupon Discount: $couponDiscount and $_isFreeDelivery and $_weight}");
              Navigator.pushNamed(
